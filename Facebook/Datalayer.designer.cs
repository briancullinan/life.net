...
namespace Facebook
{
    ...
    partial void InsertFacebookMessage(FacebookMessage instance);
    partial void UpdateFacebookMessage(FacebookMessage instance);
    partial void DeleteFacebookMessage(FacebookMessage instance);
    #endregion
		...
		public System.Data.Linq.Table<FacebookMessage> FacebookMessages
		{
			get
			{
				return this.GetTable<FacebookMessage>();
			}
		}
	}
	...
	public partial class FacebookContact : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<FacebookMessage> _FacebookMessages;
    ...
    partial void OnLocationChanged();
		...
		public FacebookContact()
		{
			...
			this._FacebookPhotos = new EntitySet<FacebookPhoto>(new Action<FacebookPhoto>(this.attach_FacebookPhotos), new Action<FacebookPhoto>(this.detach_FacebookPhotos));
			this._FacebookEvents = new EntitySet<FacebookEvent>(new Action<FacebookEvent>(this.attach_FacebookEvents), new Action<FacebookEvent>(this.detach_FacebookEvents));
			this._FacebookMessages = new EntitySet<FacebookMessage>(new Action<FacebookMessage>(this.attach_FacebookMessages), new Action<FacebookMessage>(this.detach_FacebookMessages));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FacebookContact_FacebookMessage", Storage="_FacebookMessages", ThisKey="Id", OtherKey="From")]
		public EntitySet<FacebookMessage> FacebookMessages
		{
			get
			{
				return this._FacebookMessages;
			}
			set
			{
				this._FacebookMessages.Assign(value);
			}
		}
		...
		private void attach_FacebookMessages(FacebookMessage entity)
		{
			this.SendPropertyChanging();
			entity.FacebookContact = this;
		}
		
		private void detach_FacebookMessages(FacebookMessage entity)
		{
			this.SendPropertyChanging();
			entity.FacebookContact = null;
		}
    ...
    partial void OnResponseChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Response", DbType="VarChar(20) NOT NULL", CanBeNull=false)]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.FacebookMessage")]
	public partial class FacebookMessage : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<long> _From;
    ...
    partial void OnIdChanging(long value);
    partial void OnIdChanged();
    partial void OnFromChanging(System.Nullable<long> value);
    ...
    partial void OnNameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[From]", Storage="_From", DbType="BigInt")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TimeCreated", DbType="DateTime NOT NULL", IsPrimaryKey=true)]
		public System.DateTime TimeCreated
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Caption", DbType="Text", UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FacebookContact_FacebookMessage", Storage="_FacebookContact", ThisKey="From", OtherKey="Id", IsForeignKey=true)]
		public FacebookContact FacebookContact
		{
			get
			{
			...
			set
			{
							...
							|| (this._FacebookContact.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._FacebookContact.Entity = null;
						previousValue.FacebookMessages.Remove(this);
					}
					this._FacebookContact.Entity = value;
					if ((value != null))
					{
						value.FacebookMessages.Add(this);
						this._From = value.Id;
					}
					else
					{
						this._From = default(Nullable<long>);
					}
					this.SendPropertyChanged("FacebookContact");
				}
			}
